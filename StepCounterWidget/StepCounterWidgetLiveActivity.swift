...
struct StepCounterWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = StepCounterWidgetAttributes(name: "Me")
    static let contentState = StepCounterWidgetAttributes.ContentState(value: 3)
